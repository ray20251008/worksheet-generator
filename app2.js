...
const presetTemplates = {
    ...
    gender: {
        ...
        intro: "每個人都有獨特的生理性別與心理想法。長大後，我們在身體、人際關係、親子互動與情緒管理上都會有所轉變。不論男生還是女生，喜歡並認同現在的自己就是最棒的！讓我們一起學習接納多元、體貼家人，並理解每一種情緒都是在保護我們喔！",
        mcqs: [
            {
                question: "當我們討論自己的性別時，除了天生的生理性別外，對自己的性別認同哪一個觀念最健康？",
                options: ["不論是男是女，認同並喜歡現在的自己就是最棒的！", "男生一定要很強壯，女生一定要很溫柔", "如果自己的特質和別人不一樣，就是奇怪的人", "只能照別人的期待去生活，不能有自己的想法"],
                emojis: ["❤️", "💪", "❓", "👤"]
            },
            {
                question: "如果男生想呈現女生的樣貌，或者女生想呈現男生的樣貌，可以透過什麼方式表達？",
                options: ["透過日常的穿著、髮型與打扮來呈現自己喜歡的樣貌", "嘲笑他人與眾不同的穿著打扮", "強迫每個人都必須穿一模一樣的制服與衣服", "覺得別人這樣穿很不妥，並故意遠離排擠對方"],
                emojis: ["👗", "😂", "👔", "🚫"]
            },
            {
                question: "當我們看到跨性別者（如女性轉為男性）胸口有手術的疤痕，並了解這是因為他們選擇拿掉胸部時，我們應該抱持什麼態度？",
                options: ["尊重每個人的身體選擇，只要當事人喜歡且感到開心就好", "覺得非常奇怪，甚至在背後指指點點或說壞話", "跑去質問對方為什麼要讓身體受傷留下疤痕", "認為只有完美的身體才值得被喜歡，有疤痕就是不好的"],
                emojis: ["🤝", "🗣️", "❓", "❌"]
            },
            {
                question: "隨著年紀增長，我們常會覺得家人很愛「碎碎念」。當我們想改善與家人的互動關係時，長大後的我們可以怎麼做？",
                options: ["主動幫忙做家事或常跟家人聊天分享，為家裡帶來好的改變", "嫌家人煩，直接關上門不理他們、不和他們說話", "跟家人大吼大叫，抱怨他們管太多", "故意把房間弄亂，讓家人更生氣"],
                emojis: ["🏠", "🚪", "😡", "🌋"]
            },
            {
                question: "面對負向情緒時，我們有時會感到挫折。其實情緒都有它的優點，關於「生氣」與「難過」，下面哪一個說法是正確的？",
                options: ["生氣代表在乎、難過代表需要休息，這些情緒都是在保護我們", "生氣和難過都是非常不好的表現，我們應該永遠保持開心", "生氣時可以直接動手打人，難過時可以傷害自己", "情緒是天生的，我們完全沒辦法透過練習來讓心情變好"],
                emojis: ["🛡️", "🚫", "👊", "😭"]
            }
        ],
        scenarios: [
            {
                scenario: "班上新來了一位同學，他的生理性別是男生，但他說他希望能像女生一樣穿裙子，且留長頭髮。",
                question: "👉 請畫出或寫出，你會如何用友善的態度去接納並與他做朋友？"
            },
            {
                scenario: "媽媽今天因為工作太累，回家後又開始對著你碎碎念，讓你覺得心情很煩、很想生氣。",
                question: "👉 請畫出或寫出，你會怎麼做來調整自己的脾氣，或是為媽媽做些貼心的小改變？"
            }
        ],
        pledge: {
            title: "我願意在成長的路上，認識自己並體貼他人：",
            items: [
                "喜歡並接受自己現在的性別與特質，也尊重別人的打扮與選擇。",
                "體貼家人的辛苦，主動分擔家事，多與家人聊天互動。",
                "理解生氣與難過是在保護自己，並學習用更健康的方式表達情緒。"
            ]
        }
    },
    lifelong: {
